...
namespace MediaCollection2.Controllers
{
    public class MusicsController : Controller
    {
        ...
        public MusicsController(MediaCollectionContext context)
        {
            _context = context;
        }
    public IActionResult Index()
        ...
        public async Task<IActionResult> Create([Bind("ID,Titel,ReleaseDate,Lenght,PhotoPath,WantToListen,Listened")] Music music)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Titel,ReleaseDate,Lenght,PhotoPath,WantToListen,Listened")] Music music)
        {
            if (id != music.ID)
            {
                return NotFound();
