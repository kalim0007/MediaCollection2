...
namespace MediaCollection2.Controllers.MusicControllers
{
    public class MusicDirectorsController : Controller
    {
        ...
        public MusicDirectorsController(MediaCollectionContext context)
        {
            _context = context;
        }
        ...
        {
            var Directors = _context.MusicDirectors.Include(m => m.Musics);
        ...
        private bool MusicDirectorExists(int id)
        {
            return _context.MusicDirectors.Any(e => e.ID == id);
        }
    }
}
